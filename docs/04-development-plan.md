...
| 3.10 | 销售出库 — Rust 层（库存检查、分批出库、**批次分配/实际成本快照**、自动扣减） | 2.5d | P0 | 3.7, 3.13 |
...
| M2：基础数据完成 | 第 7.5 周 | 物料/分类/供应商(**含物料关联**)/客户/仓库/**默认仓映射**/BOM(**含物料反查**)/**编码规则/库存规则基础设置**/**用户管理** |
| M2.5：采购+库存基础 | 第 11.5 周 | 采购全流程 + 库存基础能力联调通过 |
| M3：销售+定制单+库存高级 | 第 15.5 周 | 销售/**单头仓库规则**/库存高级(盘点+调拨)/预警/**批次追溯**/**lot级库存预留**/**期初库存导入**/**操作日志**/**定制单管理** |
| M4：财务报表 + 补货 | 第 18.5 周 | 应收应付/**智能补货**/报表/**标准/实际毛利**/看板 |
| M5：正式发布 | 第 22-24 周 | 三语翻译/**9种固定打印模板**/**设置收口/备份恢复**/**操作日志高级查询+导出**/**CI构建与安装包** |
