...
| 1.18a | **初始化状态检测 + 首次使用向导** — 管理员登录并完成首次改密后触发企业信息/基础仓库/导入引导 | 1.5d | 向导页组件 |
...
- [ ] 首次登录强制修改密码
- [ ] 如系统尚未完成初始化配置，管理员登录并完成首次改密后自动进入首次使用向导
...
| M5：正式发布 | 第 22-24 周 | 三语翻译/**9种固定打印模板**/**设置收口/备份恢复**/**深浅主题切换**/**操作日志高级查询+导出**/**CI构建与安装包** |
