        ...
        >
          <TableHeader className="sticky top-0 z-30 bg-white dark:bg-slate-950">
            <TableRow className="hover:bg-transparent">
              <TableHead className={`w-[8.75rem] ${BUSINESS_LIST_STICKY_HEAD_CLASS}`}>{t('outboundNo')}</TableHead>
              <TableHead className="w-[8.75rem]">{t('sourceSalesOrder')}</TableHead>
              <TableHead className="w-[6.875rem]">{t('customer')}</TableHead>
              <TableHead className="w-[5.5rem]">{t('outboundDate')}</TableHead>
              <TableHead className="w-[5rem]">{t('outboundType')}</TableHead>
              <TableHead className="w-[5rem]">{t('warehouse')}</TableHead>
              <TableHead className="w-[6.25rem] text-right">{t('outboundAmount')}</TableHead>
