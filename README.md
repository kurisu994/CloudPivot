...
| 3   | [界面原型设计](docs/03-ui-prototype.md)   | 整体布局、**39 个页面** wireframe、交互规范、全量页面地图                 |
| 4   | [开发计划](docs/04-development-plan.md)   | 甘特图、**5 个开发阶段**任务清单、技术风险                                |
| 5   | [页面开发进度清单](docs/05-page-todo-list.md) | App Router 页面开发与对接状态（39/39 已完成）            |
| 6   | [代码审查报告](docs/06-code-review-report.md) | 设计文档与代码实现差异、修复状态和剩余风险                |
...
src-tauri/                  # Rust 后端
  ...
  src/
    ...
    commands/
      ...
      inventory.rs          # 库存管理命令：查询/自由出入库/流水/盘点/调拨（14 个命令）
...
- [x] 系统设置（企业信息、编码规则、库存规则、汇率、打印、显示偏好、数据管理、操作日志、用户管理）
